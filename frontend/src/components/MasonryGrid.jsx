...
const MasonryGrid = ({ items, onItemClick, onRemove, onAddToWardrobe, wardrobeIds, viewStats, wardrobeSaveStats, hiddenBannerText }) => {
          ...
          <AnimatePresence>
            {columnItems.map((item) => (
              <ItemCard
                ...
                saveData={wardrobeSaveStats ? wardrobeSaveStats[String(item.id)] : null}
